...
def main(args):
    ...
    update = pd.read_csv(args.update, sep="\t", index_col=0)
    rename = {}
    ...
    agrees = update.loc[(update[args.agree_rank] == update["base"])]
...
if __name__ == "__main__":
    ...
    parser.add_argument("-u", "--update", help="Updated taxonomy file", required=True)
